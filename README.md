...
[![Presenter side demo](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-Demo-Preview-v0.2.5.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-Demo-v0.2.5.mp4)

35 seconds: standby, recording, teaching materials, pause, wait, break and stop/save.

**What the class sees**

[![Class side output](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-StudentView-Preview.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-StudentView.mp4)
...
[![Worksheet crops on the broadcast](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-WorksheetCrop-Preview.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-WorksheetCrop.mp4)
...
1. Download `PresenterOBS-Setup-v0.2.7.exe` only from the [official v0.2.7 release](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/tag/v0.2.7).
...
SHA-256: `121AB9FDB4320186A68FF645EEAE2BE256D0B836576BDF6163F8C974C166D427`
...
[![송출자 시선 영상](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-Demo-Preview-v0.2.5.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-Demo-v0.2.5.mp4)

35초: 대기 화면, 녹화, 수업 자료, 일시정지, 잠시만, 쉬는 시간, 중지·저장.

**학생이 보는 화면**

[![학생 시선 영상](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-StudentView-Preview.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-StudentView.mp4)

36초, 앱이 직접 녹화한 송출 화면입니다. 선생님 조작 창은 송출에서 제외되어 한 번도 보이지 않습니다.

**문제지 문항별 송출**

[![문제지 crop 송출 영상](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-WorksheetCrop-Preview.jpg)](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/download/v0.2.7/PresenterOBS-WorksheetCrop.mp4)
...
1. [공식 v0.2.7 릴리스](https://github.com/Whitening-Sinabro/presenter-obs-controller/releases/tag/v0.2.7)에서 `PresenterOBS-Setup-v0.2.7.exe`를 받습니다.
